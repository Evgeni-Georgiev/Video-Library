...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "VideoLibrary.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "vid_library";
    ...
    void addBook(String title, int year, String director, int rating, int duration) {
        ...
        if(result == -1) {
            // Application failed to insert data
    ...
    void updateData(String row_id, String title, String year, String director, String rating, String duration){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_YEAR, year);
    ...
    void deleteOneRow(String row_id){
        ...
        if(result == -1){ // if there is an Error
